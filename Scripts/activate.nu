...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Git-Gitgub\Tworzenie nowych repozytoriów\python4'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Git-Gitgub\Tworzenie nowych repozytoriów\python4\Scripts\deactivate.nu'
